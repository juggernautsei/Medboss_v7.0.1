<?php
    ...
    class GlobalConfig
    {
        const GOOGLE_ICAL_LINK = 'oe_google_ical_link';
        ...
        const GOOGLE_ENABLE_MENU = "oe_google_add_calendar_button";
        ...
        {
            $keys = [self::GOOGLE_ICAL_LINK, self::CONFIG_OPTION_CLIENT_ENCRYPTED];
            foreach ($keys as $key) {
        ...
        {
            return [
                self::GOOGLE_ICAL_LINK => [
                  'title' => 'Google iCal'
                  ,'description' => 'Enter secret address from Google calendar setting'
